...
# gf_pnts_2 <- st_as_sf(combined_GF_df,
#                       coords = c("lat", "lon"),
#                       crs = "+init=epsg:4326")
# 
# interp_gf_raster <- rast(extent = bbox(gap_frac_pnts),
#                          resolution = 1,
#                          crs = "+init=epsg:4326")
# 
...
#                 data = gf_pnts_2)
# 
# interp_gf_raster <-  interpolate(object = interp_gf_raster, model = gf_fit, index = 1)
```
