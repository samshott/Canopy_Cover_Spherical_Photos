...
kable(rbind(test_LAI[[1]],test_LAI[[2]])[1:8]) #just keep the columns with info we need
```
...
a wraper for exif tools comes in the form of a package called exifr ( @mike2022 ). Exiftools and Perl must be installed already to use exifr ( @exiftool )
