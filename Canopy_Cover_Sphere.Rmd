...
```{r read pics}
num_pics <- length(list.files("360_Pics/"))


img_paths <- paste0("360_Pics/", list.files("360_Pics")[sample.int(num_pics, 2)]) #grab 4 random 360 pictures from the picture directory
```
...
rect_imgs <- sphere_to_hemi_rect(img_paths)
