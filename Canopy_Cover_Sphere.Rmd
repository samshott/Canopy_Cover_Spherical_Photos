...
hemi_rect_to_polar <- function(hemi_rect_image){
  ...
  hemi_rect_image <- image_distort(hemi_rect_image,
                                   "Polar",
                                   c(0),
                                   bestfit = TRUE)
  ...
  hemi_polar <- image_composite(figure,
                                hemi_rect_image, 
                                operator = 'copyopacity')
  
  # paste0(as.character(min_dim/2),
  #                                               "x",
  #                                               as.character(min_dim/2))
#hemi_polar <- image_background(hemi_polar, 'black')
  
  return(hemi_polar)

##try using imager::imsub() https://dahtah.github.io/imager/imager.html
}
hemi_rect_to_polar(img_ex_half)
```
